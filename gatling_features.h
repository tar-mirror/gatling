...
/* SUPPORT_BROTLI means gatling will also look for foo.html.br and not
 * just foo.html.gz; firefox and chrome support this, but only over
 * https. */
#define SUPPORT_BROTLI
